...
class CarouselBlock(BaseBlock):
    ...
    """
    carousel = SnippetChooserBlock('base.Carousel')
...
class ModalBlock(ButtonMixin, BaseLayoutBlock):
    ...
    class Meta:
        template = 'blocks/modal_block.html'
...
class PriceListItemBlock(BaseBlock):
    ...
    class Meta:
        template = 'blocks/pricelistitem_block.html'
        icon = 'fa-usd'
...
class PriceListBlock(BaseBlock):
    ...
    class Meta:
        template = 'blocks/pricelist_block.html'
        icon = 'fa-usd'
        label = _('Price List')
...
class ContentWallBlock(BaseBlock):
    ...
    """
    content_wall = SnippetChooserBlock('base.ContentWall')
    ...
    class Meta:
        ...
        template = 'blocks/content_wall_block.html'
...
class ReusableContentBlock(BaseBlock):
    ...
    """
    content = SnippetChooserBlock('base.ReusableContent')
